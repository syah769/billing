                          ...
                          <div class="box-group">
                            ...
                            <div class="box-group-area">
                              <span>
                                ...
                                <!-- Edit and Delete options are hidden for client -->
                              </span>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="alert bg-info">
                <h5><i class="fa fa-info-circle"></i> Client Access</h5>
                <p>As a client, you have limited access to the system. You can view and use the routers but cannot add, edit, or delete them.</p>
                <p>If you need to make changes to router configurations, please contact your administrator.</p>
              </div>
