  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title"><i class="fa fa-gear"></i> <?php echo (isset($_SESSION["user_type"]) && $_SESSION["user_type"] == "client") ? "Client Settings" : $_admin_settings; ?> &nbsp; | &nbsp;&nbsp;<i onclick="location.reload();" class="fa fa-refresh pointer " title="Reload data"></i></h3>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-6">
                ...
                <div class="card-body">
                  <table class="table table-sm">
                    <tr>
                      ...
                      <td><input class="form-control" id="useradm" type="text" size="10" name="useradm" title="User Admin" value="<?= $useradm; ?>" required="1" /></td>
                    </tr>
                    <tr>
